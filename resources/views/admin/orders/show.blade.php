        ...
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6 d-flex">
                    ...
                    <h1><span class="badge @if($order->status === \App\Models\Order::ORDER_STATUS_EXECUTED) text-success @else text-info @endif ">{{ $order->statusName }}</span></h1>
                    ...
                    <div class="card">
                        <div class="card-header p-2">
                            <ul class="nav nav-pills">
                                <li class="nav-item"><a class="nav-link active" href="#activity" data-toggle="tab">Информация о заказе</a></li>
                            </ul>
                        </div>
                        <div class="card-body">
