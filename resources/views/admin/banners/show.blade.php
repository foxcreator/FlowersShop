...
@section('content')
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">{{ $banner->title_ua }}</h1>
                </div>
            </div>
        </div>
    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="post col-md-7" style="border: none">
                                            <div class="d-flex justify-content-between mb-3" style="border-bottom: 1px solid #4a5568">
                                                <p>Наименование UA</p>
                                                <h5 class="text-gray-dark">{{ $banner->title_ua }}</h5>
                                            </div>
                                            <div class="d-flex justify-content-between mb-3" style="border-bottom: 1px solid #4a5568">
                                                <p>Наименование RU</p>
                                            ...
                                            <div class="d-flex justify-content-between mb-3" style="border-bottom: 1px solid #4a5568">
                                                <p>Текст кнопки UA</p>
                                                <h5 class="text-gray-dark">{{ $banner->btn_text_ua }}</h5>
                                            </div>
                                            <div class="d-flex justify-content-between mb-3" style="border-bottom: 1px solid #4a5568">
                                                <p>Текст кнопки RU</p>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-body text-center">
                        <h5>Удалить постер - {{ $banner->title_ua }}?</h5>
                    </div>
