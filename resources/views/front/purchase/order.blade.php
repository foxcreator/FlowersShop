                ...
                <div class="tab-content show-tab" id="new">
                    <div class="order__user">
                        ...
                        <div class="order__order-form-group user-data">
                            ...
                            <input class="default-input" type="email" name="email">
                            <div>
                                <input id="switch" class="custom-switch" type="checkbox" name="anonymously">
                ...
                <div class="order__delivery">
                    ...
                    <div class="order__order-form-group delivery-block">
                        ...
                        <div class="delivery" id="delivery-content">
                            ...
                            <input class="default-input" type="text" name="street">
                            <div class="input-block">
                                <input class="default-input input-min" type="text" name="house">
                                <input class="default-input input-min" type="text" name="flat">
                            </div>
                            <div class="input-block">
                                <input id="datepicker" class="default-input input-min" type="text" name="date">
                        ...
                        <div class="recipient">
                            <input class="default-input" type="text" name="phone">
                ...
                <div class="order__gifts">
                    ...
                    <div class="add-products">
                        ...
                        <div class="postcard">
                                        ...
                                        <div class="carousel-item {{ $i === 0 ? 'active' : '' }}">
                                            <div class="row">
                                                @foreach($products->slice($i, 2) as $product)
                                                    <div class="col-md-6 position-relative">
                                                        <img style="width: 200px; height: 200px"
                                                             src="{{ $product->thumbnailUrl }}" class="d-block w-100 product-img"
                                                             data-product-id="{{ $product->id }}"
                                                             alt="{{ $product->title }}">
                                                        <div class="card-info">
                                                            <p>{{ $product->title }}</p>
                            ...
                            <input class="default-input" type="text" name="text_postcard">
                    ...
                    <div class="pay-block">
                        ...
                        <div class="payment">
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="payment_method" value="fondy"
                                       id="fondy" checked>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="payment_method" value="in_shop"
                                       id="in_shop" checked>
                                <label class="form-check-label" for="on_shop">
                                    При получении
                                </label>
                            </div>
                        </div>
